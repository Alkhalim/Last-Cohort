...
const REGIONS = {
  ambush_trail: {
    ...
    theme: 'forest', music: 'assets/audio/music/Cohort Defiant.mp3',
  ...
  hunting_grounds: {
    ...
    theme: 'forest-dark', music: 'assets/audio/music/Hunters in the Canopy.mp3',
  ...
  poisoned_bog: {
    ...
    theme: 'bog', music: 'assets/audio/music/Black Mire Pulse.mp3',
  ...
  old_forest: {
    ...
    theme: 'ancient', music: 'assets/audio/music/Roots Remember Blood.mp3',
  ...
  blood_grove: {
    ...
    theme: 'blood', music: 'assets/audio/music/Crimson Ritual.mp3',
  ...
  haunted_march: {
    ...
    theme: 'haunted', music: 'assets/audio/music/Eagle of the Unremembered.mp3',
  ...
  heart_forest: {
    ...
    theme: 'heart', music: 'assets/audio/music/Root-Rot Cathedral.mp3',
  ...
  threshold: {
    ...
    theme: 'threshold', music: 'assets/audio/music/Spirits at the Teutoburg Gate.mp3',
