...
const RAW_ITEMS = {
  ...
  "herb_pouch": { "id": "herb_pouch", "name": "Herb Pouch", "slot": "trinket", "rarity": "common", "classTags": ["command", "support", "ranged"], "stats": { "heal": 1 }, "description": "Dried marsh herbs with surprising potency." },
  ...
  "hound_collar": { "id": "hound_collar", "name": "War Hound Collar", "slot": "trinket", "rarity": "uncommon", "classTags": ["melee", "command"], "stats": { "damage": 1, "maxHp": 3 }, "description": "A spiked collar from a war hound. Wearing it feels wrong, but it toughens the spirit." },
  "mire_mothers_tusk": { "id": "mire_mothers_tusk", "name": "Mire Mother's Tusk", "slot": "weapon", "rarity": "rare", "classTags": ["melee"], "stats": { "damage": 4, "maxHp": 2 }, "special": "Kills heal the wielder for 3 HP.", "description": "A massive tusk ripped from the Mire Mother. It pulses with feral vitality." },

  // --- Difficulty 4+ unique drops ---
  "cursed_bone_blade": { "id": "cursed_bone_blade", "name": "Cursed Bone Blade", "slot": "weapon", "rarity": "uncommon", "classTags": ["melee", "command", "support"], "stats": { "damage": 2 }, "description": "A blade carved from human bone. It cuts deep but chills the hand." },
