...
const RAW_ENCOUNTERS = {
  ...
  "bossEncounters": [
    ...
    { "name": "The Leech Mound", "minDifficulty": 4, "enemies": ["leech_mound", "mire_leech", "mire_leech"], "intro": "The swamp heaves. A mound of writhing leeches rises from the muck — fused, pulsing, hungry. It is one creature made of hundreds." },
  ...
  "threatLevels": {
    ...
    "hard": [
      ...
      { "name": "The Broken Standard", "minDifficulty": 5, "enemies": ["hollow_centurion", "hollow_legionary", "cursed_warrior", "cursed_warrior"], "intro": "A shredded legion standard rises above the mist — carried by dead hands, followed by cursed feet." },
      { "name": "The Last Muster", "minDifficulty": 5, "enemies": ["hollow_centurion", "hollow_centurion", "hollow_legionary", "hollow_legionary"], "intro": "Two dead centurions call a muster that never ends. The fallen answer, rank upon rank." },
      { "name": "Carrion Watch", "minDifficulty": 5, "enemies": ["raven_caller", "raven_caller", "hollow_legionary", "forest_wraith"], "intro": "Ravens gorged on the battlefield dead circle a silent sentry. Something colder drifts behind them." },
      { "name": "Grave Escort", "minDifficulty": 5, "enemies": ["hollow_equites", "hollow_equites", "cursed_warrior", "bog_seer"], "intro": "Spectral riders flank a procession of the cursed. A seer chants the dead onward." },
      { "name": "Procession of the Dead", "minDifficulty": 5, "enemies": ["cursed_warrior", "cursed_warrior", "cursed_warrior", "bog_seer"], "intro": "Black-veined corpses shamble in single file behind a chanting seer. They do not stop for the living." },
