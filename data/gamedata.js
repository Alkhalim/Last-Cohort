...
const RAW_ENCOUNTERS = {
  ...
  "dropTables": {
    "cheruscan_raider": { "nothingChance": 0.25, "tiers": [{ "chance": 0.45, "items": ["iron_gladius", "raider_shield", "herb_pouch"] }, { "chance": 0.20, "items": ["woad_charm", "fang_necklace"] }, { "chance": 0.05, "items": ["chiefs_spear", "runic_stone"] }] },
    "sling_hunter": { "nothingChance": 0.30, "tiers": [{ "chance": 0.40, "items": ["sling_stones", "bone_needle_kit", "raider_shield"] }, { "chance": 0.20, "items": ["hunters_cloak", "scouts_sling"] }, { "chance": 0.05, "items": ["woad_charm", "runic_stone"] }] },
    "marsh_wolf": { "nothingChance": 0.25, "tiers": [{ "chance": 0.40, "items": ["wolf_pelt", "herb_pouch"] }, { "chance": 0.25, "items": ["fang_necklace"] }, { "chance": 0.10, "items": ["marsh_fang", "runic_stone"] }] },
    "fen_viper": { "nothingChance": 0.40, "tiers": [{ "chance": 0.40, "items": ["herb_pouch", "bone_needle_kit"] }, { "chance": 0.15, "items": ["fang_necklace"] }, { "chance": 0.05, "items": ["marsh_fang"] }] },
    "bog_seer": { "nothingChance": 0.30, "tiers": [{ "chance": 0.40, "items": ["herb_pouch", "bone_needle_kit"] }, { "chance": 0.20, "items": ["woad_charm", "fang_necklace"] }, { "chance": 0.10, "items": ["runic_stone"] }] },
    "oak_shield": { "nothingChance": 0.10, "tiers": [{ "chance": 0.40, "items": ["iron_gladius", "raider_shield", "wolf_pelt"] }, { "chance": 0.35, "items": ["woad_charm", "fang_necklace", "hunters_cloak"] }, { "chance": 0.15, "items": ["chiefs_spear", "runic_stone"] }] },
    "cheruscan_shieldbearer": { "nothingChance": 0.20, "tiers": [{ "chance": 0.45, "items": ["raider_shield", "iron_gladius", "wolf_pelt"] }, { "chance": 0.25, "items": ["woad_charm", "hunters_cloak"] }, { "chance": 0.10, "items": ["chiefs_spear"] }] },
    "mire_leech": { "nothingChance": 0.50, "tiers": [{ "chance": 0.35, "items": ["herb_pouch", "bone_needle_kit"] }, { "chance": 0.15, "items": ["fang_necklace", "marsh_fang"] }] },
    "wicker_man": { "nothingChance": 0.10, "tiers": [{ "chance": 0.40, "items": ["woad_charm", "herb_pouch"] }, { "chance": 0.35, "items": ["runic_stone", "fang_necklace"] }, { "chance": 0.15, "items": ["chiefs_spear", "arm_ring_of_arminius"] }] },
